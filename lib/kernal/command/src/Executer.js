...
module.exports = class Executer {
  ...
  /**
   * @param {string|object} args a command stirng or a yargs.argv object
   * @param {Executer|Command|null} spawn a command from this spawn
   */
  ...
  finalend() {
    this._events.trigger('system.action', 'end', 'command', this);
  }
